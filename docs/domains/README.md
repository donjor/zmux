...
- `agent-doctrine/**`, `pi-zmux/**`, and `skills/zmux/**` are covered by [pi-zmux-extension.md](pi-zmux-extension.md) when the change affects shared agent behavior, live-test harnesses, Pi typed tools, or agent guardrails.
...
| [pi-zmux-extension.md](pi-zmux-extension.md) | `agent-doctrine/**`, `pi-zmux/**`, `skills/zmux/**`, Pi typed tools, live-test harnesses, and agent guardrails. |
