...
| `waitfor`    | ~420  | First-class condition waiting for agent flows: fresh command lifecycle, fresh peer turn lifecycle, output-regex baseline waits, and idle/quiet fallback over `tmux.Runner`                                                                                                                                        |
