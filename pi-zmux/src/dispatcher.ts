...
export function registerZmuxDispatcher(pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "For a named joined pane, call panes with the session to resolve its raw %pane id, then pass that id to pane operations. Use pane_send_keys for literal keys without submission; pane_type appends Enter.",
