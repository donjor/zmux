...
func (t *HelpTab) helpLines() []string {
	...
	lines = append(
		...
		binding("Enter", "Go to tab (riders focus their pane; hidden panes rejoin)"),
		...
		"  "+dim.Render("another tab (zmux tab pane / tab full), or parked under"),
		"  "+dim.Render("a parent tab (zmux tab hide / tab show). send/type/watch/"),
