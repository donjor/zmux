...
func TestRunCreatesNewWindow(t *testing.T) {
	...
	runWindowName = "server"
	runSessionFlag = "test-session"
	runDetach = true
	defer func() { runWindowName = ""; runSessionFlag = ""; runDetach = false }()
...
func TestRunWaitDetectsSentinel(t *testing.T) {
	...
	runDetach = false
	runTimeout = 5
	defer func() { runWindowName = ""; runSessionFlag = ""; runDetach = false; runTimeout = 120 }()
...
func TestRunFailsWithoutSession(t *testing.T) {
	...
	runSessionFlag = ""
	runDetach = true
	defer func() { runSessionFlag = ""; runDetach = false }()
