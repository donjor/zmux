...
Examples:
  ...
  zmux t                 # alias`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if sessionName != "" {
			return listTabsForSession(sessionName)
		}
...
func listTabsForSession(session string) error {
...
func init() {
	tabsCmd.Flags().StringVarP(&tabsSessionFlag, "session", "s", "", "target session")
