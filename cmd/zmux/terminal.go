...
import (
	...
	"github.com/donjor/zmux/internal/terminaltarget"
...
var newTerminalAdapter = func() wm.Adapter { return wm.NewHyprlandAdapter() }
var newTerminalProcess = func() procfs.Inspector { return procfs.LinuxInspector{} }
...
func newTerminalCurrentCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return runTerminalCurrent(cmd, flags)
		},
	}
...
func newTerminalCapabilitiesCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args:    cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			return runTerminalCapabilities(cmd, flags)
		},
	}
...
func newTerminalRefreshCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args:  cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			return runTerminalRefresh(cmd, flags)
		},
	}
...
func runTerminalCurrent(cmd *cobra.Command, flags *terminalCurrentFlags) error {
	resolver := terminaltarget.Resolver{
		Runner:        app.Runner,
		Adapter:       newTerminalAdapter(),
		Process:       newTerminalProcess(),
...
func runTerminalRefresh(cmd *cobra.Command, flags *terminalRefreshFlags) error {
...
func runTerminalCapabilities(cmd *cobra.Command, flags *terminalCapabilitiesFlags) error {
...
func init() {
	terminalCmd.AddCommand(newTerminalCurrentCmd())
	terminalCmd.AddCommand(newTerminalCapabilitiesCmd())
	terminalCmd.AddCommand(newTerminalRefreshCmd())
